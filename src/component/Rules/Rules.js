...
import { keyFrameExampleOne, keyFrameExampleTwo } from './KeyFrames';
...
@media (max-width: 768px) {
  transform: translate(-50%, ${props => props.translate}) scale(0.8);
}
`
...
const Rules = ({ changeDisplay, rules, setStateRulesBoolean, rulesBoolean }) => {
  ...
  return (
    <WrapperRules opacity={opacity} translate={translate} display={display}>
      <span className="Rules" style={{ gridRowStart: '1', gridColumnStart: '1', justifySelf: 'left', alignSelf: 'start', margin: '0px', marginTop: '-11px', height: 'fit-content', padding: '0px', fontSize: '1.7rem', color: '#4C4C4C' }}>RULES</span>
      <div style={{ gridRowStart: '2', gridColumnStart: '1', gridColumnEnd: '3', justifySelf: 'center', height: 'fit-content' }}>
